...
@JsonPropertyOrder({"runId", "invocationId", "topic", "windowStartMs", "windowEndMs",
        "sent", "acked", "failed", "errors", "bytes",
        "ackMeanMs", "ackP50Ms", "ackP99Ms", "ackMaxMs", "hdrBase64", "final"})
public class AckReport {
    ...
    public double getAckMeanMs() { return ackMeanMs; }
    public void setAckMeanMs(double ackMeanMs) { this.ackMeanMs = ackMeanMs; }

    public double getAckP50Ms() { return ackP50Ms; }
    public void setAckP50Ms(double ackP50Ms) { this.ackP50Ms = ackP50Ms; }

    public double getAckP99Ms() { return ackP99Ms; }
    public void setAckP99Ms(double ackP99Ms) { this.ackP99Ms = ackP99Ms; }

    public double getAckMaxMs() { return ackMaxMs; }
    public void setAckMaxMs(double ackMaxMs) { this.ackMaxMs = ackMaxMs; }

    public String getHdrBase64() { return hdrBase64; }
    public void setHdrBase64(String hdrBase64) { this.hdrBase64 = hdrBase64; }
